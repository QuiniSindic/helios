  ...
  return (
    <div className="relative">
      <input
        ...
        required
        className="appearance-none rounded-lg relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 dark:text-white dark:bg-quinisindic-grey dark:border-gray-600 dark:placeholder-gray-400 focus:outline-hidden focus:ring-2 focus:ring-secondary focus:border-secondary transition-colors duration-200"
